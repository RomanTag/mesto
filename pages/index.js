...
// Создание объекта FormValidator для валидации попапа добавления нового места
...
popupAddOpenBtn.addEventListener('click', () => {
  popupNewPlaceValidator.resetValidation(); // Сброс валидации перед открытием попапа
  popupNewPlaceValidator._toggleButton(); // Обновление состояния кнопки в зависимости от валидности формы
  popupNewPlace.open();
});
